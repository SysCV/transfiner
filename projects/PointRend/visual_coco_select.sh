...
CUDA_VISIBLE_DEVICES=0 python3 demo/demo.py --config-file configs/InstanceSegmentation/pointrend_rcnn_R_50_FPN_1x_coco.yaml \
  --input '/cluster/work/cvl/leikel/hr_bound_project/detectron2-exp8-detach-semantic-light-details-nop1-postconv/coco_sel/*.jpg' \
  --output 'result_vis_pointrend_coco_sel3/' \
