...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 tools/train_net.py --num-gpus 4 --dist-url tcp://0.0.0.0:12346 \
	--config-file configs/COCO-InstanceSegmentation/mask_rcnn_R_101_FPN_3x_4gpu_finetune_deform.yaml \
        --eval-only MODEL.WEIGHTS output_3x_finetune_101_deformable/model_final.pth
